...
const MobileChat = ({token, updateComponent}) => {
    ...
    return(
        <div className="chat row m-0 w-100">
            <div className={`chat__opponents col-12 p-0 flex-column ${activeChat != null ? 'd-none' : 'd-flex'}`}>
            ...
            <div className={`col-12 ${activeChat == null && 'd-none'}`}>
                <button onClick={() => closeChat()} className="main-btn mb-3 mt-3">Назад</button>
...
export default connect(mapStateToProps, mapDispatchProps)(MobileChat)
